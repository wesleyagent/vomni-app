...
const UPGRADE_FEATURES: Record<string, { headline: string; features: string[]; price: string; plan: string }> = {
  starter: {
    ...
    price: "£79",
    features: [
      "300 review requests every month — 3x more than Starter",
      "AI insights and suggested replies",
  ...
  growth: {
    ...
    price: "£149",
    features: [
      "Unlimited review requests — no limits ever",
      "Your own dedicated SMS number",
      "Priority support",
      "Up to 3 locations",
