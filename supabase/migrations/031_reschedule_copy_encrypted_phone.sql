-- 031_reschedule_copy_encrypted_phone.sql
-- Fix: reschedule_booking_atomic was not copying customer_phone_encrypted to the
-- new booking, causing the reschedule SMS to fall back to the masked display value
-- and fail with Twilio ("'To' number cannot be a Short Code").
...
BEGIN
  ...
  INSERT INTO bookings (
    ...
    v_booking.customer_phone_encrypted,
