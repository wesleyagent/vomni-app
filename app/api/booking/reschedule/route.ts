...
export async function POST(req: NextRequest) {
  ...
  if (newBooking) {
    ...
    const date = new Date(newApptAt.substring(0, 10) + "T12:00:00Z").toLocaleDateString("en-GB", { weekday: "short", day: "numeric", month: "short", timeZone: "UTC" });
    const time = newApptAt.substring(11, 16);
