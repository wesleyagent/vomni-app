...
export default function UKComplaintsPage() {
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <Section title="If you are not satisfied with our response">
          <P>If you are unhappy with how we have handled your complaint, you can escalate to the relevant UK authority:</P>
          <Item>
            <strong>Data and privacy complaints</strong>: Information Commissioner&apos;s Office (ICO) — <a href="https://ico.org.uk" target="_blank" rel="noreferrer" style={{ color: G, textDecoration: "none" }}>ico.org.uk</a> · 0303 123 1113
          </Item>
          <Item>
            <strong>Consumer complaints</strong>: Citizens Advice consumer service — <a href="https://www.citizensadvice.org.uk" target="_blank" rel="noreferrer" style={{ color: G, textDecoration: "none" }}>citizensadvice.org.uk</a> · 0808 223 1133
          </Item>
        </Section>
