...
export default function UKAcceptableUsePage() {
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <ul style={{ fontFamily: "Inter, sans-serif", fontSize: 16, color: "#374151", lineHeight: 1.8, paddingLeft: 24 }}>
          ...
          <li>Any activity that violates Google&apos;s review policies, UK consumer protection law, the UK GDPR, the Data Protection Act 2018, or the Privacy and Electronic Communications Regulations (PECR)</li>
        ...
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 16, color: "#374151", lineHeight: 1.8 }}>
          We take misuse seriously. Accounts found to be in breach of this policy may be suspended without refund. In serious cases we will report misuse to the relevant UK authorities including the Information Commissioner&apos;s Office.
        </p>

        <h2 style={{ fontFamily: "Inter, sans-serif", fontSize: 18, fontWeight: 700, color: N, marginTop: 40 }}>Why these rules exist</h2>
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: 16, color: "#374151", lineHeight: 1.8 }}>
          Trust is the foundation of customer relationships. Misuse of messaging tools damages that trust — for the individual business, for the platform, and for customers everywhere. We hold ourselves and our customers to a high standard.
        </p>
