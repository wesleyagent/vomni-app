              ...
              {funnel.map((s, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", flex: 1 }}>
                  <div style={{ flex: 1, textAlign: "center" as const, background: i === 3 ? "rgba(0,200,150,0.08)" : "#F7F8FA", border: `1.5px solid ${i === 3 ? G : "#D1D5DB"}`, borderRadius: 8, padding: "8px 4px" }}>
                    <div style={{ fontSize: 17, fontWeight: 700, color: i === 3 ? G : N, lineHeight: 1 }}>{s.v}</div>
        ...
        <div className="container" style={{ maxWidth: 1200, margin: "0 auto", padding: "0 48px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "stretch", gap: 24, marginTop: 80, flexWrap: "wrap" }}>
            ...
            <div className="pricing-card" style={{ background: "#fff", borderRadius: 24, padding: 40, flex: "1 1 280px", maxWidth: 340, border: "2.5px solid #00C896", position: "relative", display: "flex", flexDirection: "column" }}>
              ...
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: 12, color: "#9CA3AF", marginTop: 16 }}>Perfect for: established businesses serious about keeping every customer</p>
